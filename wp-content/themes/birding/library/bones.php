...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
		...
		wp_register_script( 'birding-uisearch-js', get_stylesheet_directory_uri() . '/library/js/libs/uisearch.js' );


		
		wp_register_script( 'birding-modernizr-js', get_stylesheet_directory_uri() . '/library/js/libs/modernizr-2.6.2.min.js' );	
		wp_register_script( 'birding-jquery-ui-js', get_stylesheet_directory_uri() . '/library/js/libs/jquery-ui.js' );		
    ...
    if ( is_singular() AND comments_open() AND (get_option('thread_comments') == 1)) {
		...
		wp_enqueue_script( 'birding-modernizr-js' );
...
function bones_theme_support() {
	...
	register_nav_menus(
		array(
			...
			'main-nav' => __( 'The Main Menu', 'birding' ),   		   // mega main nav in header top
			'redes-birding' => __( 'Redes Links', 'birding' ), 		 // Redes sociales top
			'nav-top' => __( 'Menu Nav Top', 'birding' )
		)
	);
